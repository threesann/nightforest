...
function App() {
  ...
  return (
    <div className='flex flex-col gap-2 items-center justify-center w-4/5 h-screen m-auto'> {/* central column */}
      ...
      <div className='relative w-[1280px] h-[724px] border-4 border-theme-deskblue'> {/* image box */}
      ...
      <div className='flex grid grid-cols-2 gap-2 w-fit items-center'>
        <button className='bg-theme-deskblue hover:bg-theme-active text-black px-2' onClick={() => setDiscovered(true)}>look closer</button>
